...
def pattern_matching_with_suffix_arr(text, patterns):
	n = len(text)
	pos = set()
	suffix = build_suffix_array(text)
...
# 	text = lines[0] + '$'
	...
	print(*pattern_matching_with_suffix_arr(text, patterns))